...
| **baseline** | 35.69% | 18.83% | 69.14% | 496 | 1184 | 223 |
| **epoch1** | **30.24%** | **16.32%** | 67.12% | 496 | 1115 | 182 |
...
| 模型 | Epochs | POPE F1 | CHAIR_i | CHAIR_s |
|------|--------|---------|---------|---------|
| baseline (3ep) | 3 | 0.9063 | 18.83% | 35.69% |
| epoch1 (1ep) | 1 | 0.8955 | **16.32%** | **30.24%** |

**结论**: 1 epoch 训练的 CHAIR 表现显著优于 3 epochs (**CHAIR_i 16.32% vs 18.83%**)，与主实验 DPO 消融结果一致，说明 DPO 过度训练会增加幻觉。epoch1 的 CHAIR_i=16.32% 是所有 RLAIF-V 模型中最低的。
...
results/eval/dpo_rlaifv_baseline/chair_captions.json (398 KB)       ✅
results/eval/dpo_rlaifv_baseline/chair_results.json                ✅
results/eval/dpo_rlaifv_epoch1/chair_captions.json (371 KB)        ✅
results/eval/dpo_rlaifv_epoch1/chair_results.json                  ✅
```
